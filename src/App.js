...
class App extends Component {
  ...
  onClickThumbnail = id => {
    ...
    const imageIndex = imagesList.filter(eachImage => eachImage.id === id)
          ...
          <li className="tab-item" key={eachTab.tabId}>
            <button
              ...
              className={`tab-button ${
                activeCategory === eachTab.tabId ? 'highlight-tab' : ''
              }`}
              key={eachTab.tabId}
  ...
  renderThumbnailsSection = () => {
    ...
    const thumbnailsList = imagesList.filter(
      eachImage => eachImage.category === activeCategory,
    )
    return (
      <ul className="thumbnails-list">
        {thumbnailsList.map(eachThumbnail => (
          <li className="thumbnail-item" key={eachThumbnail.id}>
            <button
              type="button"
              className="thumbnail"
              key={eachThumbnail.id}
              onClick={() => this.onClickThumbnail(eachThumbnail.id)}
            >
              <img
  ...
  render() {
    const {score, timer, isStopped} = this.state
          ...
          <ul className="score-timer-container">
            <li>
              <p className="score-count">
                Score:<span className="score-count-timer"> {score}</span>
              </p>
            </li>
            <li className="score-timer-container">
              ...
              />
              <p className="score-count-timer">{timer} sec</p>
            </li>
          </ul>
        </div>
